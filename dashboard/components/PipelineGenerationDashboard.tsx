  ...
  return (
    <div>
      ...
      {periodTotals.length >= 2 && (
        <div className="card mb-8" role="img" aria-label="Pipeline movement waterfall chart showing period-over-period changes">
          <WaterfallChart
      ...
      {/* Pipeline Funnel */}
      {totalMeetings > 0 || totalDeals > 0 ? (
        <div className="card mb-8" role="img" aria-label="Pipeline funnel chart showing conversion through stages">
          <FunnelChart
        ...
        <div className="card mb-8 flex items-center justify-center h-48 text-muted-foreground">
      ...
      {repTotals.length > 0 && (
        <div className="card mb-8" role="img" aria-label="Rep quota attainment bullet chart">
          <BulletChart
      ...
      {periodTotals.length > 0 ? (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          <div className="card">
            ...
            <div role="img" aria-label="Pipeline amount by period bar chart">
          ...
          <div className="card">
            ...
            <div role="img" aria-label="Deals created and meetings by period chart">
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={periodTotals}>
                  <CartesianGrid strokeDasharray="3 3" stroke="rgba(148,163,184,0.08)" />
                  <XAxis dataKey="period_label" tick={{ fontFamily: 'var(--font-primary-sans)', fill: '#696F7B', fontSize: 12 }} />
        ...
        <div className="card mb-8">
          <h3 className="text-lg font-semibold mb-1">Pipeline & Deals by Period</h3>
          <div className="text-center py-8">
            <p className="text-sm" style={{ color: "var(--text-muted)" }}>No data available for the selected filters</p>
          </div>
        </div>
      )}
      ...
      {repTotals.length > 0 ? (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          <div className="card">
            ...
            <div role="img" aria-label="Pipeline amount by sales representative">
              <ResponsiveContainer width="100%" height={300}>
          ...
          <div className="card">
            ...
            <div role="img" aria-label="Deals and meetings by sales representative">
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={repTotals} layout="vertical">
                  <CartesianGrid strokeDasharray="3 3" stroke="rgba(148,163,184,0.08)" />
        ...
        <div className="card mb-8">
          <h3 className="text-lg font-semibold mb-1">Pipeline & Deals by Rep</h3>
          <div className="text-center py-8">
            <p className="text-sm" style={{ color: "var(--text-muted)" }}>No data available for the selected filters</p>
          </div>
        </div>
